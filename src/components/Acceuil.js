...
function App() {
  ...
  const properties = [
    ...
    { type: "Appartement", title: "Appartement Luxe", location: "Douala Akwa", size: "120 m²", price: "150,000 FCFA", img: image2 },
  ];
...
>
  ...
  <h2
    className="mb-4 text-center fw-bold animate__animated animate__fadeInDown"
    style={{ color: themeColors.text }}
  >
  ...
  <Row>
    ...
    <Col xs={12} md={4}>
      <Card
        className="mb-4 text-center animate__animated animate__zoomIn animate__delay-1s valeur-card"
      >
        <Card.Body>
          ...
          <Card.Text>
            Nous affirmons notre rôle de leader en offrant des solutions modernes et adaptées au marché.
          </Card.Text>
        </Card.Body>
      </Card>
    </Col>
    ...
    <Col xs={12} md={4}>
      <Card
        className="mb-4 text-center animate__animated animate__zoomIn animate__delay-2s valeur-card"
      >
        <Card.Body>
          <div className="valeur-icon">
          ...
          <Card.Text >
            Nous garantissons une communication claire et des informations accessibles à chaque étape.
          </Card.Text>
        </Card.Body>
      </Card>
    </Col>
    ...
    <Col xs={12} md={4}>
      <Card
        className="mb-4 text-center animate__animated animate__zoomIn animate__delay-3s valeur-card"
      >
        <Card.Body>
          <div className="valeur-icon">
          ...
          <Card.Text>
            Notre expertise et nos partenariats renforcent la confiance et la fiabilité de nos services.
          </Card.Text>
        </Card.Body>
      </Card>
    </Col>
...
{/* SECTION PREUVE DE CRÉDIBILITÉ */}
        ...
        <Row>
          <Col xs={12} md={3}>
            <Card className="mb-4 text-center animate__animated animate__fadeInUp credibilite-card">
              <Card.Body>
                ...
                <Card.Text >
                  Plus de 200 projets immobiliers menés à terme avec succès.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Card className="mb-4 text-center animate__animated animate__fadeInUp credibilite-card animate__delay-1s">
              <Card.Body>
                ...
                <Card.Text>
                  Des documents légaux et vérifiés pour chaque transaction.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col xs={12} md={3}>
            <Card className="mb-4 text-center animate__animated animate__fadeInUp credibilite-card animate__delay-2s">
              <Card.Body>
                ...
                <Card.Text >
                  Collaboration avec des entreprises et institutions reconnues.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
      ...
      <section className="services-section">
        <Container id="services" className="py-5">
          <h2
            className="fw-bold text-center animate__animated animate__fadeInDown"
          >
            Nos Services
          </h2>
          ...
          <Row className="align-items-stretch">
              ...
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <p>
                      Nous facilitons l’achat et la vente de biens immobiliers en toute sécurité.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Col xs={12} md={6} lg={3}>
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <p>
                      Des projets modernes et innovants pour répondre aux besoins du marché.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Col xs={12} md={6} lg={3}>
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <p>
                      Une gestion efficace et transparente de vos biens en location.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Col xs={12} md={6} lg={3}>
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <p>
                      Assistance complète pour vos démarches juridiques et administratives.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Bouton Plus de Services */}
      <div className="text-center mt-4">
        <a
          href="/nos-services"   // ✅ lien vers la page Nos Services
          className="btn-plus-services"
        >
